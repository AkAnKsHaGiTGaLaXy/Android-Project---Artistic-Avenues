    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent loginIntent = new Intent(AdminSignUp.this, AdminLogin.class);
        ...
        databaseReference = firebaseDatabase.getReference("Admin"); // "Admin" is the top-level node
        ...
        databaseReference.child(userId).setValue(user)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Intent LoginSucces = new Intent(AdminSignUp.this, AdminLogin.class);
