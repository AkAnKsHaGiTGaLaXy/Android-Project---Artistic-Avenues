...
public class ArtistLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRef = FirebaseDatabase.getInstance().getReference("Artist");
        ...
        SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i1=new Intent(ArtistLogin.this ,ArtistSignUp.class);
                startActivity(i1);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email) && TextUtils.isEmpty(password)) {
                    Toast.makeText(ArtistLogin.this, "Please enter both email and password", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (isAuthenticated) {
                            ...
                            Intent LoginSucces=new Intent(ArtistLogin.this ,ArtistProfile.class);
                            startActivity(LoginSucces);
                            finish();
                        } else {
                            // Authentication failed
                            Toast.makeText(ArtistLogin.this, "Authentication failed. Check email and password.", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(ArtistLogin.this, "Database Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
