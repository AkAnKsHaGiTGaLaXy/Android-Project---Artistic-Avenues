...
import com.example.artisticavenues.AdminLogin;
import com.example.artisticavenues.Customer;
import com.example.artisticavenues.R;
import com.example.artisticavenues.SessionManager;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            LogIn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent loginIntent = new Intent(com.example.artisticavenues.AdminSignUp.this, AdminLogin.class);
            ...
            databaseReference = firebaseDatabase.getReference("Artist"); // "Artist" is the top-level node
            ...
            databaseReference.child(userId).setValue(user)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Intent LoginSucces = new Intent(com.example.artisticavenues.AdminSignUp.this, AdminLogin.class);
